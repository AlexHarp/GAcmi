...
/**
 * Plugin implementation of the 'tax_compound_field_type' field type.
 *
 * @FieldType(
 *   id = "tax_compound_field_type",
 *   label = @Translation("Taxonomy compound field type"),
 ...
 * )
 */
class TaxCompoundFieldType extends FieldItemBase {
